...
public class Yaml {
     ...
     *
     * @param constructor BaseConstructor to construct incoming documents
     * @param loaderOptions LoaderOptions to control construction process
     * (unused)
     * @param representer Representer to emit outgoing objects
     * @param dumperOptions DumperOptions to configure outgoing objects
     * @param resolver Resolver to detect implicit type
     ...
     * Tag.MAP for a JavaBean to make the tag disappear (to use implicit tag
     * !!map). If <code>null</code> is provided then the standard tag with the
     ...
     * <code>null</code> is provided then the flow style from DumperOptions is
     * used.
     *
     * @return YAML String
     */
     ...
     * @param first a sequence of possible initial characters or null (which
     * means any).
     *
     */
     ...
     * in different Threads.
     *
     * @param dumper Dumper to emit outgoing objects
     */
    @SuppressWarnings("deprecation")
