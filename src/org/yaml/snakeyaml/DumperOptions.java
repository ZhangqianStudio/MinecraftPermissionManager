...
public class DumperOptions {
     ...
     *
     * @param allowUnicode if allowUnicode is false then all non-ASCII
     ...
     *
     * @param bestWidth the preferred with for scalars.
     */
    ...
    /**
     * @param expRoot tag to be used for the root node. (JavaBeans may use
     ...
     *
     * @param analysis - Scalar meta data
     * @param style - automatically detected style
     ...
     *
     * @param allowReadOnlyProperties - true to dump read-only JavaBean
     * properties
     */
